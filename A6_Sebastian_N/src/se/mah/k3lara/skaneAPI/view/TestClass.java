...
public class TestClass {
	...
	public static void main(String[] args) {
		//hämtar metoen constants.getURL med inparametrar String startStationNumber, String endStationNumber, int nbrResults
	   ...
	   //söker igenom en arraylista med stationer för resultat innehållande "Malm" och skriver sedan ut stationsnamn samt stationsnummer
